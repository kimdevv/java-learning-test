...
public class JUnit5Test {
    ...
    class DisplayNameAnnotationTest {
        ...
        void useDisplayNameToSolveWarning() {
...
//            assertInstanceOf(Object.class, object4);
        ...
        private static Stream<Arguments> methodSourcesTestArguments() {
            return Stream.of(Arguments.arguments(new Object()), Arguments.arguments(new Object()), Arguments.arguments(new Object()), Arguments.arguments(new Object()));
        }
...
//            assertEquals(numbers3.size(), 3);
        ...
        private static Stream<Arguments> methodSourceIterableTestArguments() {
            return Stream.of(Arguments.arguments(List.of(1, 4, 5)), Arguments.arguments(List.of(1, 2, 3)), Arguments.arguments(List.of(1, 3, 4)));
        }
        ...
        void MethodSource_애노테이션을_붙여_정수와_문자열_매개변수를_입력받는다(String value1, int value2) {
...
//            assertEquals(Integer.parseInt("4"), 4);
            assertEquals(Integer.parseInt(value1), value2);
        }
